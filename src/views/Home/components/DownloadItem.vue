...
const deleteDownloaded = async () => {
    ...
    modal.create({
        ...
        onPositiveClick: () => {
            downloadedStore.removeItem(props.id, deleteFileRef.value);
            message.success("删除成功");
        },
    });
};
    ...
    <div class="item-ctr">
        ...
        <div class="info-wrap">
            ...
            <div class="progress-wrap" v-if="!isMerged && status === 2">
                ...
                <div class="speed tail" v-else-if="status === 2">
                    {{ speed }}
                </div>
            </div>
